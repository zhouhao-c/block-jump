cc.Class({
    ...
    setMoveAction: function(direction){
        var moveToRight = cc.moveBy(this.moveDuration,cc.v2((this.mediaWidth+this.node.width)*direction,0));
    ...
    onCollisionEnter: function (other, self) {
        if(other.node.name == "barrier"){
            ...
            this.AudioPlayer.playstarAudio();
        }
    },
    //接触到point或者星星
    pointGain: function(point){
        var move = cc.moveBy(0.2,cc.v2(0,30)).easing(cc.easeCubicActionOut());
